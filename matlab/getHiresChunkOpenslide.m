function [img,ds_pix_x,ds_pix_y]=getHiresChunkOpenslide(openslidePointer,Nx, Ny, i, j,scalefac,padWidth)
...
ARGB=openslide_read_region(openslidePointer,by-1,bx-1,ey-by+1,ex-bx+1,'level',0);
img=ARGB(:,:,2:4);
